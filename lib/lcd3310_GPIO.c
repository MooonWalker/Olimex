...
#define LCD_MOSI_MAKE_OUT()     Pin_Output (LCD3310_MOSI_PORT, LCD3310_MOSI_PIN)
#define LCD_MOSI_HIGH()         PIN_HIGH(LCD3310_MOSI_OUT, LCD3310_MOSI_PIN)
#define LCD_MOSI_LOW()          PIN_LOW(LCD3310_MOSI_OUT, LCD3310_MOSI_PIN)

#define LCD_SCK_MAKE_OUT()      Pin_Output (LCD3310_SCK_PORT, LCD3310_SCK_PIN)
#define LCD_SCK_HIGH()          PIN_HIGH(LCD3310_SCK_OUT, LCD3310_SCK_PIN)
#define LCD_SCK_LOW()           PIN_LOW(LCD3310_SCK_OUT, LCD3310_SCK_PIN)

#define LCD_CS_MAKE_OUT()       Pin_Output (LCD3310_CS_PORT, LCD3310_CS_PIN)
#define LCD_CS_HIGH()           PIN_HIGH(LCD3310_CS_OUT, LCD3310_CS_PIN)
#define LCD_CS_LOW()            PIN_LOW(LCD3310_CS_OUT, LCD3310_CS_PIN)

#define LCD_RES_MAKE_OUT()      Pin_Output (LCD3310_RST_PORT, LCD3310_RST_PIN)
#define LCD_RES_HIGH()          PIN_HIGH(LCD3310_RST_OUT, LCD3310_RST_PIN)
#define LCD_RES_LOW()           PIN_LOW(LCD3310_RST_OUT, LCD3310_RST_PIN)

#define LCD_CD_MAKE_OUT()       Pin_Output (LCD3310_CD_PORT, LCD3310_CD_PIN)
#define LCD_CD_HIGH()           PIN_HIGH(LCD3310_CD_OUT, LCD3310_CD_PIN)
#define LCD_CD_LOW()            PIN_LOW(LCD3310_CD_OUT, LCD3310_CD_PIN)
